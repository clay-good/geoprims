...
| `add-spatial-indexing-and-raster` | Slice 1 of spatial indexing: geohash encode, decode with error margins, and neighbors (wrapping across ±180°, none past a pole); web map tiles (point to XYZ, TMS, and quadkey; tile or quadkey to bounds, with a detect mode for the y-convention mix-up; ground resolution and scale); and Plus Codes (encode, decode, shorten, and short-code recovery with a reference point, passing every case in the official Open Location Code test files) |
