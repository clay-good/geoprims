...
pub static GPS_WEEK: ToolDef = ToolDef {
    ...
    when_to_use: "Use this to place a UTC time on the GPS time scale: the week and seconds of week a RINEX header, an almanac or a receiver log wants, the 10-bit week a legacy navigation message carries, and the GPS − UTC and TAI − UTC offsets in force at that instant.",
    ...
    warnings: &["LEAP_SECOND_TABLE_EXPIRED"],
...
pub static GPS_TO_UTC: ToolDef = ToolDef {
    ...
    errors: &[],
    stability: Stability::Stable,
    when_to_use: "Use this to turn a GPS week and seconds of week back into a UTC instant: a timestamp out of a RINEX file, an almanac, a receiver log or a navigation message. Give a full week on its own, or a 10-bit week together with the era it came from.",
