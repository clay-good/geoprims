...
# MNDWI (`raster.index.mndwi`)

## Method

Replacing McFeeters' near-infrared with shortwave infrared separates water from built-up land better, because buildings and pavement reflect shortwave infrared strongly while water absorbs it.
...
Inputs: `green`, `swir1`, surface reflectance of the green and shortwave infrared 1 bands, 0 to 1 (unitless). Output: `mndwi`, unitless.
...
- sourceTitle: spyndex, the Python front end of the Awesome Spectral Indices catalog; the index as catalogued: MNDWI, from Xu (2006), International Journal of Remote Sensing
- sourceEdition: spyndex 0.12.0
- sourceLocator: `spyndex.computeIndex("MNDWI", params)`, with the catalog's constants
- independent: yes
