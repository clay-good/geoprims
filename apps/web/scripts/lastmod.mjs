 ...
 * class names, the content hashes in island and stylesheet URLs, and the Wasm
 * build hash the tool island carries for problem reports. All three move on
 * any rebuild while the page still reads exactly the same.
 */
