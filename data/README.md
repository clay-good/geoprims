...
| `reference-profile.json` | The one profile every performance, mobile, and layout budget is measured on: CPU, network, engines, viewports, and the budgets themselves, versioned. Explained in [docs/performance.md](../docs/performance.md). |
...
| `taxonomy.json` | The ten domains and their groups, including planned raster groups. The catalog build rejects missing or duplicate groups, duplicate tool ids across modules, and ids whose declared domain or group disagrees with the taxonomy. |
