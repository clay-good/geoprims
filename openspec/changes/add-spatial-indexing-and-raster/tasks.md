...
- [ ] 2.3 Implement geohash encode/decode/neighbors/cover; verify the encode, invalid-character, and antimeridian scenarios
- [ ] 2.4 Implement tile, TMS, quadkey, bbox cover, and ground resolution; verify the tile, resolution, and convention scenarios
- [ ] 2.5 Integrate Open Location Code; verify all official OLC test files and the short-code scenario
