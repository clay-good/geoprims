...
The site footer SHALL be one centered row: links to All tools, Units, Learn, Agents, Source, Privacy, Security, Accuracy, Disclaimer, and Licenses, and a "Report a problem" button. It SHALL carry nothing else.
...
- **THEN** its footer links to all ten destinations, offers "Report a problem", and holds no other text or control
