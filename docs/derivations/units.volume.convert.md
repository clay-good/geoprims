...
- independent: yes
- inputs: 22 conversions, including 50 US gallons to litres, 1 imperial gallon to US gallons, 27 cubic feet to cubic yards, and every ordered pair of the seven units
...
- `core/vectors/units.volume.convert.jsonl`: 22 vectors, the hand-picked cases and a sweep of every ordered pair
