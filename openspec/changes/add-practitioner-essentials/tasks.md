...
- [ ] 4.8 Implement the station-variation warning and NOTAM/TFR geometry; verify the variation and TFR scenarios (built: `aviation.ifr.radial-fix` finds the fix on a radial with the station's published variation and, given a date, warns STATION_VARIATION_DIFFERS when WMM2025 differs by more than 1°; the variation scenario passes; 6 golden vectors. Pending: NOTAM/TFR geometry)
