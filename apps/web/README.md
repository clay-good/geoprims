...
Not built yet: paste-to-detect and actions in the command palette, the HUD canvas, the other three theme modes, offline packs and the pack manager, import and export, docs pages, and Playwright end-to-end suites. `node scripts/serve.mjs` serves the build with its production headers and CSP.
